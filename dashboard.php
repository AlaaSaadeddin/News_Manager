...
// Fetch news with category and user info
...
if (!$result) {
    die("خطأ في جلب الأخبار: " . $connection->error);
}
...
<?php
    $page_title = "الصفحة الرئيسية  - نظام إدارة الأخبار";
    include 'header.php';
?>
<div class="p-4">
                        ...
                        <tbody>
                            <?php foreach ($news_list as $index => $news): ?>
                                <tr>
                                    ...
                                    <td>
                                        <small><?php echo $news['user_name']; ?></small>
                                    </td>
                                    <td>
