...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        // Check if category name already exists using direct query with sanitized input
        ...
        if ($result && $result->num_rows > 0) {
            ...
            // Insert new category into the database using direct query with sanitized input
